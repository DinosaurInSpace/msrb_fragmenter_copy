...
//		
//
		fragmentationPatterns.put(ClassName._1_1Z_ALKYENYL_GLYCEROPHOSPHOETHANOLAMINES, new String[][]{
				// [M+H]-H2O (-18)
				new String[]{
...
//				},
		...
		fragmentationPatterns.put(ClassName._1_ALKYL_GLYCEROPHOSPHOETHANOLAMINES, new String[][]{
				// [M+Na]-H2O (-18)
				new String[]{
...
//				.getInstance().newInstance(IAtomContainerSet.class);
		...
		if(type != StructuralClass.ClassName.NIL){
...
//				break;			
			...
			case SPHINGOMYELINS:
				...
				s_peaks = String.format("MW: %.5f", mass) + "\n" + String.format("PRECURSORMZ: %.5f",mass) + "\n" + 
						"Comment: "  + String.format("Parent= %.5f", mass)  + "; [M+H]+"+ "\n" + String.format("Num Peaks: %2d",peaks.size());
				metadata.add(s_peaks);
