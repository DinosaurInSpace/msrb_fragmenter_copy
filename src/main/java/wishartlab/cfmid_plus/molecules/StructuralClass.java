...
public class StructuralClass {
	public enum ClassName{
		...
		GLYCEROPHOSPHOLIPIDS,
			...
			GLYCEROPHOSPHATES,
				PHOSPHATIDIC_ACIDS, _1_LYSOPHOSPHATIDIC_ACIDS, _1_O_ALKENYL_GLYCEROPHOSPHATES, _2_LYSOPHOSPHATIDIC_ACIDS, PHOSPHATIDYLGLYCEROLS,
		...
		parentChildRelationships.put(ClassName.GLYCEROPHOSPHOLIPIDS,				
			...
			parentChildRelationships.put(ClassName.GLYCEROPHOSPHATES,
					new ClassName[]{ClassName.PHOSPHATIDIC_ACIDS, ClassName._1_LYSOPHOSPHATIDIC_ACIDS, ClassName._1_O_ALKENYL_GLYCEROPHOSPHATES, 
									ClassName._2_LYSOPHOSPHATIDIC_ACIDS, ClassName.PHOSPHATIDYLGLYCEROLS});		
			...
			parentChildRelationships.put(ClassName.GLYCEROPHOSPHOCHOLINES,
					new ClassName[]{ClassName.PHOSPHATIDYLCHOLINES, ClassName._1_LYSOPHOSPHATIDYLCHOLINES, ClassName._2_LYSOPHOSPHATIDYLCHOLINES, ClassName.PLASMENYLPHOSPHATIDYLCHOLINES});	
